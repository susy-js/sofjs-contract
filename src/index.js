const abi = require('sofjs-abi'); // eslint-disable-line
const sha3 = require('sofjs-sha3'); // eslint-disable-line
const SofFilter = require('sofjs-filter'); // eslint-disable-line
const getKeys = require('sofjs-util').getKeys; // eslint-disable-line
const arrayContainsArray = require('sofjs-util').arrayContainsArray;
  ...
  return function ContractFactory(contractABI, contractBytecode, contractDefaultTxObject) {
    ...
    output.at = function atContract(address) {
      function Contract() {
        ...
        self.filters = new SofFilter(query);
...
function SofContract(query) {
  return contractFactory(query);
}

module.exports = SofContract;
