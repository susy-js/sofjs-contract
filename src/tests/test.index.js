const SofContract = require('../index.js');
const Sof = require('sofjs-query');
const TestRPC = require('sophonjs-testrpc');
const provider = TestRPC.provider();
const assert = require('chai').assert;
const BN = require('bn.js'); // eslint-disable-line

describe('SofContract', () => {
  describe('should function normally', () => {
    it('should construct properly', (done) => {
      ...
      sof.accounts((accountsError, accounts) => {
        ...
        SimpleStore.new((newError, newResult) => {
          ...
          setTimeout(() => {
            sof.getTransactionReceipt(newResult, (errorReceipt, receipt) => {
              ...
              simpleStore.set(setNumberValue, (setError, setResult) => {
                ...
                setTimeout(() => {
                  sof.getTransactionReceipt(newResult, (setTxReceiptError, setTxReceipt) => {
    ...
    it('should construct properly constructor params', (done) => {
      ...
      sof.accounts((accountsError, accounts) => {
        ...
        SimpleStore.new(initalValue, initalAddreeArray, (newError, newResult) => {
          ...
          setTimeout(() => sof.getTransactionReceipt(newResult, (setTxReceiptError, setTxReceipt) => {
            ...
            */
            ...
            const args = [453,
              ...
              (multiSetTypeError, multiSetTypeResult) => {
                setTimeout(() => sof.getTransactionReceipt(multiSetTypeResult, (multiSetReceiptError, multiSetReceipt) => {
